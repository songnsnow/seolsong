...
gtf <- read.table("/home/songnsnow/download/STAR_run/reference/star.gencode.v19.transcripts.patched_contigs.gtf", sep="\t")
...
gtf <- read.table("/home/songnsnow/download/STAR_run/reference/gencode.v32.primary_assembly.annotation.gtf", sep="\t")
gtf <- subset(gtf, V3 == "exon")
write.table(data.frame(chrom=gtf[,'V1'], start=gtf[,'V4'], end=gtf[,'V5']), "/home/songnsnow/download/STAR_run/reference/fexome.bed", quote = F, sep="\t", col.names = F, row.names = F)

awk '{print $1 "\t" ($2 - 1) "\t" $3}' /home/songnsnow/download/STAR_run/reference/fexome.bed > /home/songnsnow/download/STAR_run/reference/fexome.fixed.bed

gatk \
    BedToIntervalList \
    -I /home/songnsnow/download/STAR_run/reference/fexome.fixed.bed \
    -O /home/songnsnow/download/STAR_run/reference/38.interval_list \
    -SD /home/songnsnow/download/STAR_run/reference/Homo_sapiens_assembly38.dict
